...
export const leadershipRoles: LeadershipRole[] = [
  ...
  },
  {
    ...
    summary: "Official link with Crater Seventh-day Adventist Church, Nakuru.",
    name: null,
  },
  {
    id: "secretary",
...
export const instrumentalists: Instrumentalist[] = [
  ...
  { id: "i-job-bass", name: "Job", instrument: "Bass" },
  {
    id: "i-job-sagini",
    name: "Job Sagini",
