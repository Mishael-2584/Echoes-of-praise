        ...
        <div className="container">
          <InView>
            ...
            <p className="section-lead">
              Concerts, rehearsals, and ministry across Nakuru—curated from the admin
              panel as new photos arrive.
            </p>
          </InView>
        </div>
      </section>
        ...
        <div className="container">
          ...
          {items.length === 0 && (
            <p style={{ color: "var(--mist-muted)" }}>
              Gallery photos will appear here once published from the admin panel.
            </p>
          )}
        </div>
      </section>
